...
Comprehensive review bundles (tech debt, architecture, security, error handling, performance, testing, documentation, UX, feature exploration, clang-tidy, SonarQube, platform compat, build health) are maintainer-only and live under **`internal-docs/review/`**.

**Latest bundle (2026-09-02):** `internal-docs/review/2026-09-02-v1/` (summary: `COMPREHENSIVE_REVIEW_SUMMARY_2026-09-02.md`).

Historical bundles: e.g. `internal-docs/review/2026-08-27-v1/` (summary: `COMPREHENSIVE_REVIEW_SUMMARY_2026-08-27.md`).
...
- **`guides/`** – How to build and develop
  ...
  - `guides/development/` – [MACOS_PROFILING_GUIDE.md](guides/development/MACOS_PROFILING_GUIDE.md), [CTRACK_PROFILING_GUIDE.md](guides/development/CTRACK_PROFILING_GUIDE.md), clang-tidy, logging standards, Instruments setup
...
- **`design/`** – Current architecture and design
  ...
  - USN_INGEST_PIPELINE_DESIGN – USN ingest pipeline: buffer flow, two-phase apply, staging, sweep, quarantine, repair catalog
  - USN_MFT_UBIQUITOUS_LANGUAGE – Ubiquitous language for USN/MFT code: preferred domain terms, code pointers, banned synonyms
...
| [design/USN_MFT_UBIQUITOUS_LANGUAGE.md](design/USN_MFT_UBIQUITOUS_LANGUAGE.md) | All USN/MFT work (preferred domain terms; no synonyms) |
