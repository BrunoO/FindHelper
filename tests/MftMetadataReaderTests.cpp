...
struct RawFileRecordHeader {
  ...
  ULONGLONG BaseFileRecordNumber : 48 = 0;
  ULONGLONG BaseFileRecordSequence : 16 = 0;
...
struct RawFileName {
  ULONGLONG ParentDirectory : 48 = 5;
  ULONGLONG ParentSequence : 16 = 1;
