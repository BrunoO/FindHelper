...
#include "filters/TimeFilterUtils.h"   // TimeFilterToString, TimeFilterFromString, TimeFilterDisplayLabel, CalculateCutoffTime
...
TEST_SUITE("TimeFilterUtils") {
    ...
    TEST_SUITE("TimeFilterDisplayLabel") {
        TEST_CASE("matches filter-bar wording and is empty for None") {
            CHECK(std::string_view(TimeFilterDisplayLabel(TimeFilter::Today)) == "Today");
            CHECK(std::string_view(TimeFilterDisplayLabel(TimeFilter::ThisWeek)) == "This Week");
            CHECK(std::string_view(TimeFilterDisplayLabel(TimeFilter::ThisMonth)) == "This Month");
            CHECK(std::string_view(TimeFilterDisplayLabel(TimeFilter::ThisYear)) == "This Year");
            CHECK(std::string_view(TimeFilterDisplayLabel(TimeFilter::Older)) == "Older");
            CHECK(std::string_view(TimeFilterDisplayLabel(TimeFilter::None)).empty());
        }
    }
