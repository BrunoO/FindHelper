...
// no volume attached. Covers EnumUsnJournal transcript delivery, cursor advance
// (UsnJournalEnumerationPosition), EOF termination, and the GetVolumeData reserve
...
// Scripted VolumeGateway: replays canned EnumUsnJournal buffers, then EOF with
