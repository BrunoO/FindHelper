...
// IMPORTANT: These unit tests exercise parsing/validation only and do not call the live Gemini API.
// Set GEMINI_API_KEY only for tests that explicitly integrate with the network (none in this file).
