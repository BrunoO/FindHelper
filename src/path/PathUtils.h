 ...
 */
[[nodiscard]] constexpr bool IsVolumeRootPath(std::string_view path) noexcept {
 ...
 */
[[nodiscard]] constexpr bool IsDriveLetterRootKey(std::string_view path) noexcept {
 ...
 */
[[nodiscard]] constexpr bool IsVolumeRootChildPath(std::string_view path) noexcept {
 ...
 */
[[nodiscard]] constexpr bool IsVolumeWidePathPrefix(std::string_view prefix) noexcept {
 ...
 */
[[nodiscard]] constexpr size_t DirectoryPrefixLength(std::string_view path,
