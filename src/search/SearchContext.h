...
struct SearchContext {
    ...
    ItemTypeFilter item_type_filter = ItemTypeFilter::All; // Filter by item type (All, FilesOnly, FoldersOnly)

    bool folders_only = false;               // Only return directories (synced with item_type_filter)
