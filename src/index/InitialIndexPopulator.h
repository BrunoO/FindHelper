...
// index_integrity_compromised: Optional latch set if a corrupt USN record is skipped
//   (remaining buffer dropped). Caller (UsnMonitor) surfaces "Index may be stale".
...
bool PopulateInitialIndex(HANDLE volume_handle, FileIndex &file_index,
                          ...
                          std::atomic<bool>* index_integrity_compromised = nullptr);
