...
class VolumeState {
 public:
  ...
  // Path indexing is deferred to RecomputePathsAndPruneOrphans (same single-
  // pass contract as IndexBuildRun::CommitBatch): entries are stored without
  // paths until the recompute indexes every path exactly once.
