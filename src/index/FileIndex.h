...
public:
  ...
  void Insert(ntfs_file_reference::NtfsFileReference id,
    ...
    InsertLocked(id, parent_id, name, is_directory, modification_time, options);
  ...
  // Owned batch entry for bulk population (e.g. MFT enumeration).
  ...
  // Pre-size index maps, name arena, path storage and dedup chains before a
