...
class Theme {
 public:
  ...
  struct Colors {
    ...
    // Match highlighting in results (name column); distinct from selection Accent
    static ImVec4 MatchHighlight;  // NOLINT(readability-identifier-naming) - PascalCase semantic color API
  ...
  struct HeaderAlphas {
    ...
    static constexpr float TableHeader = 0.28F;  // NOLINT(readability-identifier-naming) - PascalCase semantic API
  };
