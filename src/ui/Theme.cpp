...
ImVec4 Theme::Colors::SurfaceHover = ImVec4(0.18F, 0.18F, 0.18F, 1.00F);
ImVec4 Theme::Colors::SurfaceActive = ImVec4(0.24F, 0.24F, 0.24F, 1.00F);
ImVec4 Theme::Colors::FrameBg = ImVec4(0.15F, 0.15F, 0.15F, 1.00F);
ImVec4 Theme::Colors::FrameBgHover = ImVec4(0.20F, 0.20F, 0.20F, 1.00F);
ImVec4 Theme::Colors::FrameBgActive = ImVec4(0.26F, 0.26F, 0.26F, 1.00F);
...
ImVec4 Theme::Colors::TextDisabled = ImVec4(0.48F, 0.48F, 0.48F, 1.00F);
...
ImVec4 Theme::Colors::MatchHighlight = ImVec4(0.95F, 0.80F, 0.25F, 1.00F);
...
const ThemePalette kDefaultDark = {
  ...
  ImVec4(0.18F, 0.18F, 0.18F, 1.00F),  // SurfaceHover (#2D2D2D, widened for perceptible hover feedback)
  ImVec4(0.24F, 0.24F, 0.24F, 1.00F),  // SurfaceActive (#3D3D3D)
  ImVec4(0.15F, 0.15F, 0.15F, 1.00F),  // FrameBg (#262626)
  ImVec4(0.20F, 0.20F, 0.20F, 1.00F),  // FrameBgHover (#333333)
  ImVec4(0.26F, 0.26F, 0.26F, 1.00F),  // FrameBgActive (#424242)
  ...
  ImVec4(0.48F, 0.48F, 0.48F, 1.00F),  // TextDisabled (~5.8:1 on #141414, passes AA for small text)
...
const ThemePalette kDracula = {
  ImVec4(0.106F, 0.112F, 0.144F, 1.00F),  // Surface
  ImVec4(0.160F, 0.166F, 0.202F, 1.00F),
...
const ThemePalette kNord = {
  ImVec4(0.122F, 0.138F, 0.170F, 1.00F),  // #2e3440
  ImVec4(0.170F, 0.187F, 0.232F, 1.00F),
...
const ThemePalette kOneDark = {
  ImVec4(0.106F, 0.118F, 0.138F, 1.00F),  // #282c34
  ImVec4(0.136F, 0.147F, 0.170F, 1.00F),
...
const ThemePalette kGruvbox = {
  ...
  ImVec4(0.50F, 0.75F, 0.70F, 1.00F),     // Success (~#80BFBF aqua; hue-distinct from yellow Warning)
...
const ThemePalette kEverforest = {
  ...
  ImVec4(0.55F, 0.72F, 0.45F, 1.00F),     // Success (darker/cooler green; distinct from Accent)
...
const ThemePalette kCatppuccin = {
  ...
  ImVec4(0.271F, 0.278F, 0.353F, 1.00F),  // FrameBg (#45475a - Surface 1; elevated for input affordance)
  ImVec4(0.345F, 0.357F, 0.439F, 1.00F),  // FrameBgHover (#585b70 - Surface 2)
  ImVec4(0.420F, 0.435F, 0.520F, 1.00F),  // FrameBgActive (#6B6F85)
  ImVec4(0.424F, 0.439F, 0.525F, 1.00F),  // Border (#6c7086 - Overlay 0)
  ImVec4(0.796F, 0.651F, 0.969F, 1.00F),  // Accent (#cba6f7 - Mauve)
  ImVec4(0.706F, 0.749F, 0.996F, 1.00F),  // AccentHover (#b4befe - Lavender; same hue family, brighter)
...
void CopyPaletteToColors(const ThemePalette& palette) {
  ...
  // Amber/gold match highlight: reuse Warning so palettes stay in sync without extra fields.
  Theme::Colors::MatchHighlight = palette.warning_;
...
void Theme::SetupColors() {
  ...
  colors[ImGuiCol_PopupBg] = Colors::SurfaceHover;
  ...
  colors[ImGuiCol_ScrollbarGrab] = Colors::SurfaceActive;       // Interactive grab, not a structural border
  colors[ImGuiCol_ScrollbarGrabHovered] = Colors::Border;       // Steps toward border on hover
  colors[ImGuiCol_ScrollbarGrabActive] = Colors::Accent;        // Accent when dragging
