 ...
 *
 * Use these in UIRenderer, WelcomePanel, StatusBar, and FilterPanel so "breathing room"
...
struct LayoutConstants {
  ...
  /** Number of ImGui::Spacing() calls for welcome panel hero area above main message. */
  static constexpr int kWelcomePanelHeroSpacingCount = 3;
  /** Number of vertical spacing units before the welcome panel split panel (examples | recent). */
  static constexpr int kWelcomePanelPanelSpacingCount = 1;
  ...
  /** Horizontal gap between welcome panel left panel (examples) and right panel (recent). */
  static constexpr float kWelcomePanelSplitPanelGutter = 8.0F;
