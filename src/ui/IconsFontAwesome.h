...
#define ICON_FA_THUMBTACK "\xef\x82\x8d"        // U+F08D // NOSONAR(cpp:S5028) // NOLINT(cppcoreguidelines-macro-usage)
#define ICON_FA_PIN "\xef\x82\x8d"              // U+F08D (alias) // NOSONAR(cpp:S5028) // NOLINT(cppcoreguidelines-macro-usage)
#define ICON_FA_PEN "\xef\x8c\x84"              // U+F304 (FA5+) // NOSONAR(cpp:S5028) // NOLINT(cppcoreguidelines-macro-usage)
...
#define ICON_FA_FOLDER "\xef\x81\x9b"           // U+F07B // NOSONAR(cpp:S5028) // NOLINT(cppcoreguidelines-macro-usage)
#define ICON_FA_FILE "\xef\x84\x9b"             // U+F15B // NOSONAR(cpp:S5028) // NOLINT(cppcoreguidelines-macro-usage)
#define ICON_FA_FILE_LINES "\xef\x87\x9c"       // U+F15C // NOSONAR(cpp:S5028) // NOLINT(cppcoreguidelines-macro-usage)
#define ICON_FA_NOTE_STICKY "\xef\x89\x89"       // U+F249 // NOSONAR(cpp:S5028) // NOLINT(cppcoreguidelines-macro-usage)
...
#define ICON_FA_PAUSE "\xef\x81\x8c"            // U+F04C // NOSONAR(cpp:S5028) // NOLINT(cppcoreguidelines-macro-usage)
...
#define ICON_FA_HISTORY "\xef\x87\x9a"          // U+F1DA // NOSONAR(cpp:S5028) // NOLINT(cppcoreguidelines-macro-usage)
