...
public:
   ...
   *
   * @param id File ID
   * @param parent_id Parent directory ID
   * @param name File name
   * @param is_directory Whether this is a directory
   * @param modification_time File modification time
   * @param register_mft_record When true, register id in the MFT record-number
   *        map (USN/FRN). When false, skip (synthetic InsertPath ids).
   *
